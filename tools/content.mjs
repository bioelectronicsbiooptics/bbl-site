...
export const courseMIE = {
  ...
  weeks: [
    ...
    { no: 6, en: "Chemical DNA Synthesis at Scale", ko: "DNA의 화학적 합성과 대량 생산", topicsEn: "Phosphoramidite cycle · yield · oligo pools · microarrays", topicsKo: "포스포라미다이트 합성 사이클 · 수율 · oligo pool · microarray", materials: [{ en: "Lecture 6-1 · Phosphoramidite chemistry: one base at a time (HTML slides)", ko: "6-1강 · 포스포라미다이트 화학 — 한 번에 한 염기씩 (HTML 슬라이드)", href: "../courses/molecular-information-engineering/week06/lecture6-1.html" }, { en: "Lecture 6-2 · Parallel synthesis on chips, oligo pools and purification (HTML slides)", ko: "6-2강 · 칩 병렬 합성 · 올리고 풀 · 정제 (HTML 슬라이드)", href: "../courses/molecular-information-engineering/week06/lecture6-2.html" }, { en: "Supplement · Principles of HPLC (HTML slides)", ko: "보충 · HPLC의 원리 (HTML 슬라이드)", href: "../courses/molecular-information-engineering/week06/hplc.html" }] },
    { no: 7, en: "Enzymatic Synthesis, Synthetic Biology and Xeno Nucleic Acids", ko: "효소적 합성, 합성생물학과 확장 핵산", topicsEn: "TdT · template-free synthesis · assembly · XNA", topicsKo: "TdT · template-free 합성 · 조립 · XNA", materials: [{ en: "Lecture 7-1 · Enzymatic synthesis (TdT) and gene assembly (HTML slides)", ko: "7-1강 · 효소 합성(TdT)과 유전자 조립 (HTML 슬라이드)", href: "../courses/molecular-information-engineering/week07/lecture7-1.html" }, { en: "Lecture 7-2 · Xeno nucleic acids (XNAs) (HTML slides)", ko: "7-2강 · XNA 확장 핵산 (HTML 슬라이드)", href: "../courses/molecular-information-engineering/week07/lecture7-2.html" }, { en: "Lee, Kang, Yu, Haider, Lim, Song — XNAs: advances in synthesis, diagnostics, and therapeutics, Bioorg. Chem. 179 (2026) 110000", ko: "리뷰 논문 · XNAs: advances in synthesis, diagnostics, and therapeutics, Bioorg. Chem. 179 (2026) 110000", href: "https://doi.org/10.1016/j.bioorg.2026.110000" }] },
